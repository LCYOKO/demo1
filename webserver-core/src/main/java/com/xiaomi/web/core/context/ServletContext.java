package com.xiaomi.web.core.context;


import com.xiaomi.web.core.context.holder.FilterHolder;
import com.xiaomi.web.core.context.holder.ServletHolder;
...
import com.xiaomi.web.core.session.IdleSessionCleaner;
import com.xiaomi.web.core.util.UUIDUtil;
import com.xiaomi.web.core.util.XMLUtil;
import lombok.Data;
...
import static com.xiaomi.web.core.constant.ContextConstant.DEFAULT_SERVLET_ALIAS;
import static com.xiaomi.web.core.constant.ContextConstant.DEFAULT_SESSION_EXPIRE_TIME;
    ...
    private Servlet initAndGetServlet(String servletAlias) throws ServletNotFoundException {
        ...
        if (servletHolder.getServlet() == null) {
            try {
                ...
                log.error("init servlet failed.", e);
            }
