...
//        this.s = s;
//        distTo = new Number[G.getNodes()];
//        marked = new boolean[G.getNodes()];
//        from = new Edge[G.getNodes()];
...
//        IndexMinHeap<Weight> ipq = new IndexMinHeap<>(G.getNodes());
//
//        // 对于其实点s进行初始化
//        distTo[s] = 0.0;
...
//            System.out.print(path.elementAt(i).getFirstNode() + " -> ");
//            if (i == path.size() - 1)
//                System.out.println(path.elementAt(i).getWeight());
//        }
//    }
//}
